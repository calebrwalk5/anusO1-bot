...
client.on('message', message => { // i know, i know. i'm a bad programmer for doing this
  ...
  } else if (message.content.startsWith(`${PREFIX}banjellyman`)) {
